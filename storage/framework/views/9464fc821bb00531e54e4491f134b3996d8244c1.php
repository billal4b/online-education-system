...
<div class="dashboard-form">
    <div class="row">
        <form  action="<?php echo e(route('admin.secondebook.update', $edit->id)); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
        <!-- Profile -->
        <div class="col-lg-12 col-md-12 col-xs-12">
            <?php echo $__env->make('flash-message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="dashboard-list-box">
                <h4 class="gray">Update eBook <a href="<?php echo e(route('admin.ebook')); ?>"><span class="button gray">List</span></a></h4>
                <div class="dashboard-list-box-static">
                    <div class="my-profile">
                        <label for="published">
                            <input type="checkbox" name="published" id="published" value="<?php echo e($edit->published); ?>" <?php if($edit->published): ?> checked <?php endif; ?>>
                            Publish?
                        </label>
                        <label for="publish_time" class="publish_date"><strong>Date</strong></label>
                        <input id="publish_time" name="publish_time" type="text" value="<?php echo e($edit->publish_time); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <input id="topic" name="topic" type="text" value="<?php echo e($edit->topic); ?>"
                            ...
                            <div class="col-md-2">
                                <label for="content_type_both">
                                    <input type="radio" name="content_type" id="content_type_both"
                                           value="<?php echo e(EBOOK_BOTH); ?>" <?php if($edit->content_type == EBOOK_BOTH): ?> checked <?php endif; ?> >
                                    Both
                                </label>
                            </div>
                            <div class="col-md-2">
                                <label for="content_type_content">
                                    <input type="radio" name="content_type" id="content_type_content"
                                           value="<?php echo e(EBOOK_CONTENT); ?>" <?php if($edit->content_type == EBOOK_CONTENT): ?> checked <?php endif; ?>>
                                    Editor
                                </label>
                            </div>
                            <div class="col-md-2">
                                <label for="content_type_document">
                                    <input type="radio" name="content_type" id="content_type_document"
                                           value="<?php echo e(EBOOK_DOCUMENT); ?>" <?php if($edit->content_type == EBOOK_DOCUMENT): ?> checked <?php endif; ?>>
                                    Document
                                </label>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                  required> <?php echo e($edit->content); ?></textarea><br>
...
unset($__errorArgs, $__bag); ?><br>
                        <p><a href="/public/ebook/<?php echo e($edit->document); ?>" target="_blank"><?php echo e($edit->document); ?></a></p>
                    </div><br>
...
<script>
    jQuery(document).ready(function () {
        ...
        // var bookStatus = '<?php echo e($edit->published); ?>'
        // if (bookStatus == '<?php echo e(EBOOK_UNPUBLISHED); ?>'){
        //     $('.publish_date').hide();
        // }
    ...
    document.getElementById('subject_type').value = '<?php echo e($edit->subject_type); ?>';

</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('backend.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/iqsbdcom/public_html/resources/views/backend/secondebook/edit.blade.php ENDPATH**/ ?>