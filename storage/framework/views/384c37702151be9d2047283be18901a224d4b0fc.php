                ...
                <div class="col-sm-4 col-xs-12">
                    <div class="inner-grid text-center">                        
                        ...
                        <div class="courses-content">
                            ...
                            <a href="<?php echo e(url('/quran-teaching-course')); ?>" class="mt_btn_yellow">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-xs-12">
                    <div class="inner-grid text-center">                        
                        ...
                        <div class="courses-content">
                            ...
                            <a href="<?php echo e(url('/arabic-language-teaching-course')); ?>" class="mt_btn_yellow">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-xs-12">
                    ...
                    <div class="col-sm-12">
                        <div class="about-items">
                            <div class="inner-heading">
                                <h3><a href="/about-us"><?php echo $aboutUs->title; ?></a></h3>
                            </div>
                            ...
                            <div class="col-sm-9">
                                <div class="about-sch-form">
                                    <div class="event-title">
                                        <h2><?php echo $apply->title; ?></h2>
                                        <p><?php echo $apply->content; ?></p>
                                    </div> <!-- event title -->                                    
                                </div>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="blog-post_wrapper">
                                <div class="blog-post-inner_wrapper">
                                    <div class="blog-post-image">
                                        <div class="clearfix">
                                            <div class="img">
                                                <img src="public/images/blog/<?php echo $blog->image; ?>" alt="image" class="img-responsive center-block post_img" /> </div>
                                        </div>
                                    </div>
                                    <div class="post-detail_container">
                                        <div class="post-content">
                                            <h5 class="post-title entry-title">
                                                <a href="<?php echo e(route('blog.post', $blog->slug)); ?>"><?php echo $blog->title; ?></a>
                                            </h5>
                                            ...
                                            <div class="view_detail text-center">
                                                <a href="<?php echo e(route('blog.post', $blog->slug)); ?>" class="mt_btn_yellow">Read more</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
</html><?php /**PATH /home2/iqsbdcom/public_html/resources/views/frontend/template.blade.php ENDPATH**/ ?>