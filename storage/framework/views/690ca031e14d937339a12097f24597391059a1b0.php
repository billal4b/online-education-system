        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-12">
                ...
                <div class="post_title">
                    <h3><?php echo e($lastPdf->title); ?></h3>
                    <strong><?php echo e($lastPdf->courses->course_name); ?></strong>
                    <ul class="list-inline list-unstyled">
                        <li>
                            <i class="ion-ios-calendar-outline"></i>&nbsp; <?php echo date('d-m-Y', strtotime($lastPdf->created_at)); ?>&nbsp;
                        </li>
                    </ul>
                </div>
                <div class="post_body">
                    <?php echo $lastPdf->content; ?>

                </div>
                <br>
                <?php if($lastPdf->pdf_file != ''): ?>
                <strong class="noticelink">
                    <a href="/public/pdf/<?php echo $lastPdf->pdf_file; ?>" target="_blank"> Please Click Here </a>
                </strong>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/iqsbdcom/public_html/resources/views/frontend/pages/pdf.blade.php ENDPATH**/ ?>