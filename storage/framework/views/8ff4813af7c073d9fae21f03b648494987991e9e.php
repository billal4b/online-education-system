...
<section id="the-gallery" class="wide-gallery inner-gallery section-inner">
    <div class="container">
        <div class="inner-heading">
            <h3><?php echo e($todC->courses->course_name); ?> (<?php echo e($genderId); ?>)</span></h3>
        </div>
    </div>
</section>
<!-- new-->
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/iqsbdcom/public_html/resources/views/frontend/pages/today/today_class_all.blade.php ENDPATH**/ ?>