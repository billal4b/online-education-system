<section id="the-gallery" class="wide-gallery inner-gallery section-inner">
    <div class="container">
        <div class="inner-heading">
            <h3>Quran Teaching Course (<?php echo e($c->gender); ?>)</span></h3>
        </div>
    </div>
</section>
 <section id="mt_fun">
    ...
    <div class="container">
        ...
        <div class="row slider slider-ft-course">
            ...
            <?php $__currentLoopData = $crs_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($course->course_title == 'Quran Teaching Course'): ?>    
...
<?php /**PATH /home2/iqsbdcom/public_html/resources/views/frontend/pages/today/today_class_quran.blade.php ENDPATH**/ ?>