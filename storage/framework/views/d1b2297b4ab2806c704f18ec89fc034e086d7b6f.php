...
<?php $__env->startSection('pages'); ?>
                                        ...
                                        <div class="post-detail_container">
                                            <div class="post-content">
                                                ...
                                                <ul class="list-unstyled list-inline post-metadata">
                                                    <li><i class="ion-ios-stopwatch-outline"></i>&nbsp<?php echo date('d-m-Y', strtotime($blog->date_time)); ?>&nbsp</li>                                                  
                                                </ul>
    ...
    <!--*End Blog div Sec*-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/iqsbdcom/public_html/resources/views/frontend/pages/blog.blade.php ENDPATH**/ ?>