                ...
                <ul class="nav navbar-nav navbar-right" id="responsive-menu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(url('/hifjul-quran-male')); ?>"><?php echo e(__('Hifzul Quran for adults Male')); ?> </a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('/hifjul-quran-female')); ?>"><?php echo e(__('Hifzul Quran for adults Female')); ?> </a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('/islamic-studies')); ?>"><?php echo e(__('Islamic Studies')); ?> </a>
                            </li>
                        </ul>
                    </li>
                    <li>
...
</style><?php /**PATH /home/iqsbdcom/public_html/resources/views/frontend/header.blade.php ENDPATH**/ ?>