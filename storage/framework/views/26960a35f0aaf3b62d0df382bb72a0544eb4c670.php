...
<div class="dashboard-form">
        <div class="row">
            <form  action="<?php echo e(route('admin.blog.store')); ?>" method="post" novalidate enctype="multipart/form-data">                
                <?php echo csrf_field(); ?> 
               
                <!-- Profile -->
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="dashboard-list-box">
                        <h4 class="gray">Add Blog <a href="<?php echo e(route('admin.blog')); ?>" ><span class="button gray">List</span></a></h4>
...
unset($__errorArgs, $__bag); ?>" required autocomplete="image" autofocus><br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/iqsbdcom/public_html/resources/views/backend/blog/create.blade.php ENDPATH**/ ?>