...
<div class="dashboard-form">
    <div class="row">
        <form  action="<?php echo e(route('admin.question.update', $edit->id)); ?>" method="post">
            <?php echo csrf_field(); ?>
            <!-- Profile -->
            <div class="col-lg-12 col-md-12 col-xs-12">
                <div class="dashboard-list-box">
                    <h4 class="gray">Update Question <a href="<?php echo e(url()->previous()); ?>"><span class="button gray">List</span></a></h4>
                    <div class="dashboard-list-box-static">
                        <!-- Details -->
                        <div class="my-profile">
                            <label for="exam_title"><strong><?php echo e(__('Exam Title')); ?></strong></label>
                            <input id="exam_title" name="exam_title" type="text" value="<?php echo e($edit->exam_title); ?>" class="form-control <?php $__errorArgs = ['exam_title'];
...
unset($__errorArgs, $__bag); ?>" rows="15" required><?php echo $edit->question; ?></textarea>
...
unset($__errorArgs, $__bag); ?>   <br>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-12">
                                        ...
                                        <input id="start_time" name="start_time" type="text" value="<?php echo $edit->start_time; ?>" class="form-control datetimepicker <?php $__errorArgs = ['start_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-xs-12">
                                        ...
                                        <input id="duration" name="duration" type="text" value="<?php echo ($edit->duration)/60; ?>" class="form-control <?php $__errorArgs = ['duration'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('backend.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/iqsbdcom/public_html/resources/views/backend/question/edit.blade.php ENDPATH**/ ?>