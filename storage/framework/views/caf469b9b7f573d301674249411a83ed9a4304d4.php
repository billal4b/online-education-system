    ...
    <div class="col-lg-12 col-md-12 col-xs-12">
        ...
        <div class="row">  
            ...
            <div class="col-lg-2 col-md-3 col-xs-12 imgUp" align="center">   
                ...
                <form  action="<?php echo e(route('user.profile.picture', Auth::user()->id)); ?>" method="post" novalidate enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>                              
...
unset($__errorArgs, $__bag); ?> 
            ...
            <div class="col-lg-8 col-md-6 col-xs-12">
                <div class="dashboard-list-box">
                    <h4 class="gray">My Profile<a href="<?php echo e(route('user.profile.edit', Auth::user()->id)); ?>" ><span class="button gray">Edit Profile</span></a></h4>
                    <div class="dashboard-list-box-static">
                       <div class="course"> 
                           <?php if(!empty(Auth::user()->select_course)): ?>
                                <?php $__currentLoopData = Auth::user()->select_course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(isset($courses[$v])): ?>
                                       <strong><?php echo e($courses[$v]); ?></strong>,
                                    <?php endif; ?>
                        ...
                        <div class="my-profile">
                            ...
                            <label><strong><?php echo e(__('Birth of Date')); ?></strong><span> <?php echo e(Auth::user()->dob); ?></span></label>
                            <label><strong><?php echo e(__('Address')); ?></strong><span> <?php echo e(Auth::user()->address); ?></span></label>
                            <label><strong><?php echo e(__('BR/NID')); ?></strong><span> <?php echo e(Auth::user()->nid_no); ?></span></label>
                        </div>
                    </div>
                </div>
            </div>   
...
<?php echo $__env->make('userend.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/iqsbdcom/public_html/resources/views/userend/users/user_profile.blade.php ENDPATH**/ ?>