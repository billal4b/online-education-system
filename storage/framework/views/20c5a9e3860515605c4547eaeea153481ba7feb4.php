            ...
            <!-- Profile -->
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="dashboard-list-box">
                        <h4 class="gray">Add eBook <a href="<?php echo e(url()->previous()); ?>"><span
...
unset($__errorArgs, $__bag); ?>
                                <label for="pdf_file" class="document_area"><strong><?php echo e(__('PDF File')); ?></strong></label>
                                <input id="pdf_file" name="pdf_file" type="file"
                                       class="document_area form-control <?php $__errorArgs = ['pdf_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('backend.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/iqsbdcom/public_html/resources/views/backend/ebook/createdemo.blade.php ENDPATH**/ ?>