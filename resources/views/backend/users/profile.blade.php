    ...
    <div class="col-lg-12 col-md-12 col-xs-12">
        ...
        <div class="row">  
            ...
            <div class="col-lg-2 col-md-3 col-xs-12 imgUp" align="center">   
                ...
                <form  action="{{ route('admin.profile.picture', Auth::user()->id) }}" method="post" novalidate enctype="multipart/form-data">
                    @csrf                              
            ...
            <div class="col-lg-8 col-md-6 col-xs-12">
                <div class="dashboard-list-box">
                    <h4 class="gray">My Profile<a href="{{ route('admin.edit', Auth::user()->id) }}" ><span class="button gray">Edit Profile</span></a></h4>
                    <div class="dashboard-list-box-static">
                        ...
                        <div class="my-profile">
                            ...
                            <label><strong>{{ __('NID') }}</strong> <span> {{ Auth::user()->nid_no }}</span></label>
