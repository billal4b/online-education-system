...
<div class="dashboard-form">
        <div class="row">
            <form  action="{{ route('admin.blog.store') }}" method="post" novalidate enctype="multipart/form-data">                
                @csrf 
               
                <!-- Profile -->
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="dashboard-list-box">
                        <h4 class="gray">Add Blog <a href="{{ route('admin.blog') }}" ><span class="button gray">List</span></a></h4>
                        <div class="dashboard-list-box-static">
                            ...
                            <div class="my-profile"> 
                                ...
                                <textarea id="excerpt" name="excerpt" class="form-control @error('excerpt') is-invalid @enderror"> </textarea><br>
                                    @error('excerpt')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row" id="imageSize">    
                                    <div class="col-lg-6 col-md-6 col-xs-12">
                                        ...
                                        <input id="image" name="image" type="file" class="form-control @error('image') is-invalid @enderror" required autocomplete="image" autofocus><br>
