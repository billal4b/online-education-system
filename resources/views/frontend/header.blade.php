    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function navbar-arrow">
        <div class="container">
            <div class="logo pull-left">
                <h2><a href="https://iqsbd.com/"><img class="logo-img" src="{{asset('public/images/logo-white.png')}}" alt=""><img
                                class="logo-img logo-black" src="{{asset('public/images/logo-black.png')}}" alt=""></a></h2>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right" id="responsive-menu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ url('/hifjul-quran-male')}}">{{ __('Hifzul Quran for adults Male') }} </a>
                            </li>
                            <li>
                                <a href="{{ url('/hifjul-quran-female')}}">{{ __('Hifzul Quran for adults Female') }} </a>
                            </li>
                            <li>
                                <a href="{{ url('/islamic-studies')}}">{{ __('Islamic Studies') }} </a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('dictionary.arabic') }}">{{ __('Quranic Dictionary') }}</a></li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="{{ route('audio') }}">{{ __('Audio Tilawat ') }}</a></li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('pledge') }}">{{ __('Pledge Form') }}</a></li>
                            @if(Auth::check())
                    ...
                    @else
                        <li><a href="{{ route('register.form') }}">{{ __('Register') }}</a></li>
