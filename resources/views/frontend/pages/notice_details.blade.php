            ...
            <div class="col-md-8 col-sm-12">
                ...
                <div class="post_title">
                    ...
                    <ul class="list-inline list-unstyled">                        
                        <li>
                            <i class="ion-ios-calendar-outline"></i>&nbsp; {!! date('d-m-Y', strtotime($noticeDetails->publish_at)) !!}&nbsp; 
                        </li>                      
                    </ul>
                </div>
                <div class="post_body">
                ...
                <br>
                @if ($noticeDetails->file != '')
                <strong class="noticelink">                    
                    <a href="/public/notice/{!! $noticeDetails->file !!}" target="_blank"> Please Click Here </a>
                </strong>  
                @endif       
            </div>
