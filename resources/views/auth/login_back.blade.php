...
{{--                <div class="col-lg-6 col-md-12 col-xs-12" style="background-image: url('{{asset('/images/bg-login.png')}}')"></div>--}}
                <div class="col-lg-7 col-md-8 col-xs-12 hidden-sm hidden-xs" style="padding: 0">
                    <div style="background-image: url('../public/images/bg-login.png');background-repeat: no-repeat;background-size: contain;height: 88vh"></div>
                </div>
